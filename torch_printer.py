...
# This file defines a printer for pytorch code, for use
# in sympy's lambdify. This code is the work of Zer0Credibility
# from their excellent sympy PR to add native torch support to
# lambdify (which, frustratingly, already supports tensorflow,
# but not pytorch!). To me, it looks like this PR is nearly
# complete, awating only some final fixes and approvals,
# so, once it is integrated into sympy proper, we should just
# update to the latest version of sympy and stop depending
# on this copied code.

# The original repository containing this code is here:
